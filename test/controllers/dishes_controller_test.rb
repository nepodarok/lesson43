...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { desc: @dish.desc, name: @dish.name, price: @dish.price, shop_id: @dish.shop_id }
    end
  ...
  test "should update dish" do
    patch :update, id: @dish, dish: { desc: @dish.desc, name: @dish.name, price: @dish.price, shop_id: @dish.shop_id }
    assert_redirected_to dish_path(assigns(:dish))
  end
